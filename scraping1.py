...
tweets = tweepy.Cursor(api.search, q=search_words, since="2020-09-07", tweet_mode='extended').items()
print("=============")
...
for tweet in tweets:
    try:
        ...
        print(cc, cc_location, cc_coordinate, cc_place)    
...
stream.filter(track=searches, is_async=True)
'''
'''
while True:
    try:
